...
def make_model(hidden_neurons, k_reg, a_reg, ap_fixed, sigmoid=False):
    model = Sequential()
    
    # layer 1
    model.add( QDense(hidden_neurons, input_shape=(10,),
                      name='hd1',
...
#     layer 4
    ...
    model.add( QDense(1,
                      ...
                      kernel_regularizer=k_reg) )
    if sigmoid:
        model.add( Activation(name='act5', activation='sigmoid') ) 
